...
cdef class vector_array_base:
    ...
    def __neg__(self):
        cdef vector_array_base res = vector_array_base()
        res._vector = cvector.neg(self._vector)
        res.shape = self.shape
        return res
    ...
    def abs(self):
        cdef vector_array_base res = vector_array_base()
        res._vector = cvector.abs(self._vector)
        res.shape = self.shape
        return res

  
    def reduce_min(self):
        return min(self.to_numpy_array())
    
    def reduce_minabs(self):
        return cvector.reduce_minabs(self._vector)
    
    def reduce_max(self):
        return max(self.to_numpy_array())

    def reduce_maxabs(self):
        return cvector.reduce_maxabs(self._vector)
    ...
    cdef double* get_data(self):
        cdef double* a = cvector.get_data(self._vector)
        return a
