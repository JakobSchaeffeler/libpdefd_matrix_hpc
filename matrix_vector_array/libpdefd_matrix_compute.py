...
if backend_str == 'scipy':
    try:
        ...
        sys.path.pop()
elif backend_str == 'mkl' or backend_str == 'mkl_blas':
    try:
        ...
        sys.path.pop()
elif backend_str in ['mkl_cython_typed', 'mkl_cython_malloc', 'mkl_cython_cpp']:
    try:
        from libpdefd.matrix_vector_array.matrix_vector_array_cython.libpdefd_matrix_compute_cython_mkl import *
    except:
        import sys, os
        sys.path.append(os.path.dirname(__file__))
        from matrix_vector_array_cython.libpdefd_matrix_compute_cython_mkl import *
        sys.path.pop()
else:
