...
int main(int argc, char**argv){
	...
	FILE *f_min; 
	FILE *f_max;
	sprintf(str_f, "blas_c_imul_%d_%d.csv", N, cores);
	sprintf(str_f_min, "blas_c_imul_%d_%d_min.csv", N, cores);
	sprintf(str_f_max, "blas_c_imul_%d_%d_max.csv", N, cores);
	x_a = NULL;
	x_b = NULL;
   	y_a = NULL;
    	y_b = NULL;
	...
	for(int i = 0; i < 10; i++){
		...
		imul_vector_blas(x_blas, y_blas);
	...
	sprintf(str_f, "blas_c_imul_%d_%d_scalar.csv", N, cores);
	sprintf(str_f_min, "blas_c_imul_%d_%d_scalar_min.csv", N, cores);
	sprintf(str_f_max, "blas_c_imul_%d_%d_scalar_max.csv", N, cores);
	...
	fclose(f_min);
	fclose(f_max);
	sprintf(str_f, "vml_c_imul_%d_%d.csv", N, cores);
	sprintf(str_f_min, "vml_c_imul_%d_%d_min.csv", N, cores);
	sprintf(str_f_max, "vml_c_imul_%d_%d_max.csv", N, cores);
	...
	fclose(f_min);
	fclose(f_max);
	sprintf(str_f, "vml_c_imul_%d_%d_scalar.csv", N, cores);
	sprintf(str_f_min, "vml_c_imul_%d_%d_scalar_min.csv", N, cores);
	sprintf(str_f_max, "vml_c_imul_%d_%d_scalar_max.csv", N, cores);
